...
<body>
  <div class="container py-1" ng-app="DemoApp" ng-controller="DemoController as Ctrl">
    <div class="row">
      <div class="col-sm-12">
        <h1 class="mb-2">Angular Dragtable</h1>
        <p>Directive that allows reorder of table columns.</p>
      ...
      <div class="col-sm-12">
        <table class="table table-sm table-striped table-hover">
            <thead class="thead-inverse">
                <tr>
                    <th>ID</th>
                    <th drag-me drop-me data-limit="50" data-delay="1000" data-handle=".handle">Name <span class="badge badge-info handle">Handle</span></th>
                    <th drag-me drop-me data-limit="50" data-delay="1000" data-handle=".handle">Description <span class="badge badge-info handle">Handle</span></th>
                    <th drag-me drop-me data-limit="50" data-delay="1000" data-handle=".handle">Age <span class="badge badge-info handle">Handle</span></th>
                </tr>
            </thead>
            <tbody>
                <tr>
